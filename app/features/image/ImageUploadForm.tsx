...
// // ใช้ generic type เพื่อให้ยืดหยุ่น รองรับ field ที่อาจมีชื่อหรือค่าต่างกันได้
// // TFieldValues: เป็น generic ที่แทน รูปแบบของข้อมูลทั้งหมดในฟอร์ม (object ของฟอร์ม)
// // เช่น { image: string; title: string }
// // TName: เป็น generic ที่แทน ชื่อของ field หนึ่ง ๆ ภายในฟอร์มนั้น
// // เช่น "image" หรือ "title"
// // การเขียน <TFieldValues, TName> หลัง function คือการบอกว่า:
// // "ฟังก์ชันนี้สามารถทำงานกับข้อมูลฟอร์มอะไรก็ได้ และจะรู้ว่าชื่อของ field ที่ส่งเข้ามาคืออะไรแบบ type-safe"
...
//     field.onChange(imageId); // ✅ ใช้ onChange จาก react-hook-form
//   };

//   const handleRemoveImage = async () => {
//     // สำหรับกรณีอัปโหลดได้รูปเดียว และลบรูปโดยที่ component ยังอยู่ ใช้สำหรับกรณี image เดี่ยวๆ เช่น image: ""
//     field.onChange("");
//     field.value && remove && remove(); // ลบ component นั้นๆ ออกเลย ใช้สำหรับกรณี image เป็น fieldArray เช่น images:["",...]
...
//           >
//             <Image
//               src={`${process.env.NEXT_PUBLIC_IMAGE_HOST_URL}/${field.value}`}
//               alt="Uploaded"
//               sizes="300px"
//               fill
...
const ImageUploadForm = forwardRef<HTMLDivElement, Props<any, any>>(
