...
// import FileUploadForm from "@/app/features/image/FileUploadForm";
...
//       const valueIds = combo.map((item) => item.id);
//       const vId = valueIds.join("-");
...
//   // Find variation by tierIndex
//   const findVariation = (tierIndex: number[]) => {
//     return variations.findIndex((v) => {
//       if (
//         !v ||
//         !v.tierIndex ||
//         !Array.isArray(v.tierIndex) ||
//         v.tierIndex.length !== tierIndex.length
//       )
//         return false;
//       return v.tierIndex.every((val, idx) => val === tierIndex[idx]);
//     });
//   };

//   // Find option value index by value
//   const findOptionValueIndex = (optionIndex: number, value: string) => {
//     if (!options[optionIndex]?.values) return -1;
//     return options[optionIndex].values.findIndex(
...
//               <span className="text-gray-700">รายการตัวเลือกสินค้า</span>
//               <div className="flex-1"></div>
//               <span className="text-gray-500 text-sm">ราคา</span>
//               <span className="text-gray-500 text-sm ml-8">คลัง</span>
//               <span className="text-gray-500 text-sm ml-8">เลข SKU</span>
//             </div>
...
//                       <th
//                         key={index}
//                         className="p-3 text-left font-normal border-r"
//                       >
//                         <div className="flex items-center">
//                           {index === 0 && (
//                             <div className="w-2 h-2 rounded-full bg-orange-500 mr-2"></div>
...
//                       </th>
//                     ))}
//                     <th className="p-3 text-left font-normal border-r">
//                       <div className="flex items-center">
...
//   // ติดตามทุกการเปลี่ยนแปลงของ option
//   useEffect(() => {
//     generateVariations();
//     console.log(`All option${optionIndex} values:`, watchedOptions);
//   }, [watchedOptions]);
