...
export default function CreatePromotion() {
  ...
  async function onSubmit(data: PromotionFormValues) {
    ...
    // promotion activity data
    PromotionFormData.append("productId", selectedProduct?.id || "");
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <Tabs defaultValue="promotion" className="w-full">
          {/* Promotion data */}
          <TabsContent value="promotion" className="space-y-6 px-2">
            {/* type */}
            <FormField
              control={form.control}
              name="type"
          ...
          <TabsContent value="promotionDetail" className="space-y-6 px-2">
            {/* product reference */}
          ...
          <div className="flex flex-col gap-2 p-3">
            <TabsList className="my-2 w-full flex gap-2 justify-between">
              <TabsTrigger value="promotion">ย้อนกลับ</TabsTrigger>
              <TabsTrigger value="promotionDetail">หน้าถัดไป</TabsTrigger>
            </TabsList>
