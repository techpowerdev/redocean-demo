                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 grid gap-4">
                      ...
                      <div className="grid grid-cols-2 items-center gap-4">
                        ...
                        <div>
                          {commissionPolicy.data.referralCommissionRate} บาท ต่อ
                          1 บัญชีที่สมัครเป็น affiliate สำเร็จ
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="rounded-lg border shadow-sm">
                  <div className="p-6">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">
                      ...
                      หลังจากที่ยอดขายได้รับการยืนยันและผ่านช่วงเวลาคืนสินค้า
                      (15 วัน) โดยจะโอนย้ายไปสะสมเป็นยอดรายได้ไว้ในบัญชี
                      affiliate ของคุณ
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border shadow-sm">
                  <div className="p-6">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">
                      ...
                      Affiliate ของเรา
                      ซึ่งมีรายงานและกราฟแสดงผลการดำเนินงานของคุณ
                    </p>
                  </div>
                </div>
              </div>
