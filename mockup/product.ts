export const products = [
    ...
    images: [
      {
        ...
        colorCode: "#FFFFFF",
        image:
          "https://images.unsplash.com/photo-1580870069867-74c57ee1bb07?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHNraW5jYXJlfGVufDB8fDB8fHww",
      },
      {
        color: "Black",
        colorCode: "#000000",
    ...
    images: [
      {
        color: "Black",
        colorCode: "#000000",
        image: "/black-logitech-keyboard.webp",
      },
    ],
    reviews: [
      {
  ...
  },
  {
    ...
    description:
      "บิ๊ก﻿กรรมาชน เซ็กซี่ไฮไลท์ ฉลุยโหงวเดชานุภาพไฮไลท์ โลชั่น ลิสต์แกรนด์ดิสเครดิต เฮียสโตนแฟ็กซ์ออร์แกนิกบอยคอต ทำงานสปอร์ตวิวบลอนด์หล่อฮังก้วย ไฮแจ็คมอลล์สุนทรีย์เพลย์บอย เห็นด้วยเช็กซานตาคลอสกรอบรูป ฟลุตไฮไลต์เนิร์สเซอรี่แอดมิชชั่นหลวงปู่ ร็อคคอรัปชันราสเบอร์รีเพนตากอน อาข่าม้าหินอ่อนปาร์ตี้ฮอตดอกพ่อค้า เอ็นทรานซ์คอรัปชันไฮบริด เสกสรรค์โฟมเซอร์ไพรส์ซิ้มรีสอร์ท ดีพาร์ทเมนท์โมจิยาวีชัตเตอร์ มอนสเตอร์",
    price: 40,
    brand: "Apple",
    category: "Phone",
    inStock: true,
    images: [
      {
        color: "Black",
        colorCode: "#000000",
        image: "/iphone12-black.webp",
      },
      {
        color: "Blue",
        colorCode: " #0000FF",
        image: "/iphone12-blue.webp",
      },
      {
        color: "Red",
        colorCode: "#FF0000",
        image: "/iphone12-red.webp",
      },
    ],
    reviews: [
      {
    ...
    images: [
      {
        color: "Graphite",
        colorCode: " #383838",
        image: "/logitech-graphite-mouse.webp",
      },
    ],
    reviews: [],
  },
    ...
    images: [
      {
        color: "Black",
        colorCode: "#000000",
        image: "/watch-black.webp",
      },
      {
        color: "Silver",
        colorCode: "#C0C0C0",
        image: "/watch-silver.webp",
      },
    ],
    reviews: [],
  },
